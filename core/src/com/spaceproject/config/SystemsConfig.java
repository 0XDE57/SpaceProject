...
public class SystemsConfig extends Config {
    ...
    public void loadDefault() {
        ...
        //sorted by priority. priority = order of execution. with gaps for easy insertion of new systems.
        //flags
        ...
        systems.add(new SysCFG(DebugSystem.class, 190, false, true, true, true, true));
